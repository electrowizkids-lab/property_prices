      ...
      <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white py-16 md:py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl font-light text-indigo-100 max-w-2xl mx-auto">
            Indirapuram's Most Advanced Property Valuation Engine. Powered by algorithmic data, not human bias.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-16 relative z-20 w-full flex-grow">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
          ...
          <div className="flex border-b border-gray-200 bg-gray-50">
            <button onClick={() => setMode('seller')} className={`flex-1 py-5 text-sm font-bold uppercase tracking-wider transition ${mode === 'seller' ? 'bg-white border-b-4 border-indigo-600 text-indigo-700' : 'text-gray-500 hover:text-gray-700'}`}>
              Sell / Evaluate Property
            </button>
            <button onClick={() => setMode('buyer')} className={`flex-1 py-5 text-sm font-bold uppercase tracking-wider transition ${mode === 'buyer' ? 'bg-white border-b-4 border-indigo-600 text-indigo-700' : 'text-gray-500 hover:text-gray-700'}`}>
              Check Market Rates
            </button>
          </div>
              ...
              <div>
                ...
                <form onSubmit={handleSellerEstimate} className="space-y-6">
                  <div>
                    ...
                    <input type="tel" name="phone" value={formData.phone} onChange={handleChange} required placeholder="Enter 10-digit number" className="w-full px-4 py-3.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition text-gray-900"/>
                  </div>
                ...
                {result && (
                  <div className="mt-10 space-y-6 border-t border-gray-100 pt-10">
                    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 rounded-2xl text-white shadow-xl">
                      ...
                      <button type="button" onClick={() => alert("Your details have been shared with top local brokers!")} className="mt-6 w-full bg-white text-indigo-700 font-bold py-3.5 rounded-xl hover:bg-indigo-50 transition text-sm shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-md">
              Indirapuram's most advanced algorithmic property valuation engine. We use deep market data, government circle rates, and micro-locality adjustments to give you the true value of your asset.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wider mb-4 text-slate-300">Quick Links</h4>
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#" className="hover:text-white transition">Evaluate Property</a></li>
              <li><a href="#" className="hover:text-white transition">Market Trends</a></li>
              <li><a href="#" className="hover:text-white transition">For Brokers</a></li>
            </ul>
          </div>
          <div>
